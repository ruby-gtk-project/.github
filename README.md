...
| `initial-port.md` | daily | Decides which forks are port targets. | Creates `Initial port: <fork>` and `Gem release: <fork>` issues here, bodies copied from `.github/port-issues/`, and adds both to the Initial port project. |
